...
<template>
  ...
  >
    <NuxtLink
      ...
      :class="{ 'bg-secondary text-secondary-content': route.path === props.href, 'justify-center': !showLabel, 'justify-start': showLabel }"
      class="flex gap-2 p-2 bg-info text-info-content hover:bg-accent hover:cursor-pointer flex-nowrap"
    >
      <Icon
        :name="props.icon"
        size="24"
